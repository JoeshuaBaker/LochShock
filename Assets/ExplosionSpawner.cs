...
public class ExplosionSpawner : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (explosionTime > explosionInterval && testDangerZones)
        {
            ...
            CreateDangerZone(1000f, 1f, randomPlacement , true , false , false, new Vector3(randomSize , randomSize , 0f), false, randomRotation, 3);
    ...
    public GameObject CreateDangerZone(float damage, float delay , Vector3 position, bool dealsDamage , bool safeOnPlayer , bool noPS , Vector3 scale, bool squareShape, Quaternion rotation, int craterSize)
    {
        int i;
        ...
        spawnedDangerZone.Setup(damage, delay, position , dealsDamage , safeOnPlayer, noPS , scale, squareShape, rotation, craterSize);
